...
export const routes = [
  {
    ...
    module: '/repo/packages/scheduling-engine/actions/scheduling-management.mjs',
    exportName: 'default',
    invoke: 'params-pg',
  },
  ...
  //   is merged into params. Identity from x-tenant-id/x-auth-subject/x-actor-type.
  {
    ...
    methods: ['POST'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/async-operation-create.mjs',
    exportName: 'main',
  ...
  //   the query string (?queryType=detail), defaulting to detail.
  {
    ...
    methods: ['GET'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/async-operation-query.mjs',
    exportName: 'main',
    invoke: 'params-overrides',
    deps: ['db'],
    mergeQueryIntoParams: true,
  ...
  //   platform:admin:config:export scope). main(params) — params-only.
  {
    ...
    methods: ['GET'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/tenant-config-format-versions.mjs',
    exportName: 'main',
    invoke: 'params-only',
  },
  ...
  //   (No producer is wired; emitPlanEvent no-ops when its producer is absent.)
  {
    ...
    pathRegex: /^\/v1\/plans\/?$/,
    methods: ['POST'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/plan-create.mjs',
    exportName: 'main',
  ...
  //   Returns 200 with { plans, total, page, pageSize }.
  {
    ...
    pathRegex: /^\/v1\/plans\/?$/,
    methods: ['GET'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/plan-list.mjs',
    exportName: 'main',
    invoke: 'params-callercontext-overrides',
    deps: ['db'],
    mergeQueryIntoParams: true,
  ...
  //   exact /v1/plans regex above, so route order does not matter.
  {
    ...
    methods: ['GET'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/plan-change-history-query.mjs',
    exportName: 'main',
    invoke: 'params-callercontext-overrides',
    deps: ['db'],
    mergeQueryIntoParams: true,
  ...
  //   Applies the forward-only plan status state machine. Requires superadmin.
  {
    ...
    methods: ['POST'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/plan-lifecycle.mjs',
    exportName: 'main',
    invoke: 'params-callercontext-overrides',
    deps: ['db'],
    mergeBodyIntoParams: true,
  ...
  //   the forward lifecycle archive path instead.
  {
    ...
    methods: ['DELETE'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/plan-delete.mjs',
    exportName: 'main',
    invoke: 'params-callercontext-overrides',
    deps: ['db'],
  },
  ...
  //   { dimensions, total }.
  {
    ...
    methods: ['GET'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/quota-dimension-catalog-list.mjs',
    exportName: 'main',
    invoke: 'params-callercontext-overrides',
    deps: ['db'],
  },
  ...
  //   42P01 is caught), but the slice applies 104 too.
  {
    ...
    methods: ['GET'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/tenant-effective-entitlements-get.mjs',
    exportName: 'main',
    invoke: 'params-callercontext-overrides',
    deps: ['db'],
    mergeQueryIntoParams: true,
  ...
  //   false (no snapshot seeding needed).
  {
    ...
    methods: ['GET'],
    module: '/repo/packages/backup-status/src/api/backup-status.action.js',
    exportName: 'main',
    invoke: 'params-owhttp',
    setClientModule: '/repo/packages/backup-status/src/db/repository.js',
    mergeQueryIntoParams: true,
  },
  ...
  //   (migration 105).
  {
    ...
    methods: ['POST'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/workspace-sub-quota-set.mjs',
    exportName: 'main',
    invoke: 'params-callercontext-overrides',
    deps: ['db'],
    mergeBodyIntoParams: true,
  ...
  //   workspaceId, dimensionKey, limit, offset). Returns 200 with { items, total }.
  {
    ...
    pathRegex: /^\/v1\/workspace-sub-quotas\/?$/,
    methods: ['GET'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/workspace-sub-quota-list.mjs',
    exportName: 'main',
    invoke: 'params-callercontext-overrides',
    deps: ['db'],
    mergeQueryIntoParams: true,
  ...
  //   path has no tenant segment, matching the deployed kind runtime route map.
  {
    ...
    methods: ['GET'],
    module: '/repo/packages/provisioning-orchestrator/src/actions/workspace-consumption-get.mjs',
    exportName: 'main',
    invoke: 'params-callercontext-overrides',
    deps: ['db'],
  },
