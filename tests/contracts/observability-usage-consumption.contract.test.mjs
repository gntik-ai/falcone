...
test('architecture README and task summary document the usage-consumption baseline', { skip: !existsSync('docs/reference/architecture/README.md') || !existsSync('docs/tasks/us-obs-03.md') }, () => {
