...
import { APPLICATION_HANDLERS } from '../../deploy/kind/control-plane/application-handlers.mjs';
...
const bHandlersSource = readFileSync(new URL('../../deploy/kind/control-plane/b-handlers.mjs', import.meta.url), 'utf8');
