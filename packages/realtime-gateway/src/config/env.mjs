...
export function loadEnv(source = process.env) {
  ...
  return {
    ...
    KEYCLOAK_ISSUER: assertNonEmptyString(source.KEYCLOAK_ISSUER, 'KEYCLOAK_ISSUER'),
    KEYCLOAK_AUDIENCE: assertNonEmptyString(source.KEYCLOAK_AUDIENCE, 'KEYCLOAK_AUDIENCE'),
