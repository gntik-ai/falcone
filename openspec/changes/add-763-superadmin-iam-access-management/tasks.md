...
- [x] 1.3 Confirm no backend, OpenAPI, generated SDK, or shared-type change is required because the
  console consumes the existing IAM endpoints.
...
- [x] 4.3 Run `pnpm --dir apps/web-console test src/pages/ConsoleIamAccessPage.test.tsx`.
- [x] 4.4 Run `openspec validate add-763-superadmin-iam-access-management --strict`.
