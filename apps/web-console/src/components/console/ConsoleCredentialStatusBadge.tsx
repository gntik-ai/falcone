...
// `ConsoleAuditResultBadge` and `getConsoleContextStatusBadgeClasses` (`lib/console-context.tsx`,
// used by `ConsoleShellLayout.tsx`): emerald for a healthy/active credential, a distinct tone
// (violet) for rotated (not a failure, but no longer the live secret), red/destructive for revoked,
