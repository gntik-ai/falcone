...
export function AuthLayout() {
  ...
  // login route itself. Every other route keeps exactly one of the two as a live affordance.
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-background text-foreground">
        ...
        <div className="mx-auto flex w-full max-w-5xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
          {isWelcomeRoute ? (
            ...
            <Link to="/" className="flex items-center gap-3 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background">
              <img src="/img/logo-wide.png" alt="Volver al inicio de In Falcone Console" className="h-9 w-auto" />
            </Link>
          )}
      ...
      <main className="flex flex-1 items-start justify-center px-4 py-8 sm:px-6 sm:py-12 lg:items-center lg:px-8 lg:py-16">
