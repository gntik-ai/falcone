...
//      reused from packages/webhook-engine via isBlockedIp), with numeric-IPv4 normalization
...
import { isBlockedIp } from '../../../../packages/webhook-engine/src/webhook-subscription.mjs';
...
// --------------------------------------------------------------------------------------------
// Endpoint SSRF guard. Mirrors apps/workflow-worker/src/activities/ssrf.mjs: numeric-IPv4
