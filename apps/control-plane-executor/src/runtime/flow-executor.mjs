...
} from '../../../../packages/internal-contracts/src/flow-definition-schema-validator.mjs';
...
// (apps/workflow-worker). The worker's approval signal is `flowApproval` (one channel; the
...
// validator (packages/internal-contracts/src/flow-definition-validator.mjs) — never a
