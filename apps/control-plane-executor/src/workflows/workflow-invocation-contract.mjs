...
import { readAuthorizationModel } from '../../../../packages/internal-contracts/src/index.mjs';

const INVOCATION_SCHEMA_URL = new URL('../../../../packages/internal-contracts/src/console-workflow-invocation.json', import.meta.url);
