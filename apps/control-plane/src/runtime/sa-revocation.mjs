...
//
// PARITY with deploy/kind/control-plane/sa-revocation.mjs (the two control-plane runtimes are kept
...
//
// The `service_accounts` table is OWNED by the kind control-plane (deploy/kind/control-plane/
