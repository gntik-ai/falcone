...
//
// The product ships an engine `services/adapters/src/storage-capacity-quotas.mjs`
...
// however, CANNOT statically import services/adapters — that engine statically pulls in
// apps/control-plane/src/observability-admin.mjs (the large governance catalog), a
...
// DEFAULT_STORAGE_BUCKET_LIMIT (services/adapters/src/storage-tenant-context.mjs:147).
