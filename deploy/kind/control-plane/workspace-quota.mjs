...
const QUOTA_REPO = '/repo/services/provisioning-orchestrator/src/repositories/quota-enforcement-repository.mjs';
const QUOTA_MODEL = '/repo/services/provisioning-orchestrator/src/models/quota-enforcement.mjs';
